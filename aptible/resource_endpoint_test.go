		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aptible_endpoint.test", "endpoint_domain", "www.aptible-test-demo.fake"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aptible_endpoint.test", "platform", "alb"),
					resource.TestCheckResourceAttrSet("aptible_endpoint.test", "endpoint_id"),
					resource.TestMatchResourceAttr("aptible_endpoint.test", "endpoint_domain", regexp.MustCompile(`app-.*\.on-aptible\.com`)),
				),
			},
		},
	})
